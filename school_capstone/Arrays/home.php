...
Purpose of this page: This page displays the home page for arrays assignment, and shows all the data no sorting involved.
...
<!--end Menu-->
<!--content--> 
    <!--For home page, we're just printing everything.-->
   <div class="content">
   ...
   <?php 
        ...
        //print all data
        //loop through array (idea from w3schools example)
        echo "<table>";
