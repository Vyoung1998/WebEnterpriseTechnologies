...
Purpose of this page: This page displays the information for employee 2: Jason Hallow.
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   ...
   <!--menu-->
    ...
    <!--left column-->
    <div class = "emp_left">
        <img src="Jason.png" alt="A young man barista with blonde hair and brown eyes. He is smiling" height = 200px width= auto>
    </div>
    <!--right column-->
    <div class="emp_right">
        <?php 
        include 'variables.php';
            echo "
            <h1>Hello! My name is " . $emp2_name . ".</h1>
            <hr>
            <h3>I am " . $emp2_age . " years old.</h3>
            <h3>My job title is " . $emp2_jobTitle . ".</h3>
            <h3>My favorite drink is a " . $emp2_favDrink . ".</h3>
            <h3>My favorite scripture in the Bible is " . $emp2_favScripture . ".</h3>
            ";
        ?>
    </div>
    </div>
