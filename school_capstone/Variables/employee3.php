...
Purpose of this page: This page displays the information for employee 3: Oscar Whitworth.
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   ...
   <!--main content-->
    ...
    <!--left column-->
    <div class = "emp_left">
        <img src="Oscar.png" alt="An older man barista with red, greying hair and brown eyes. He is smiling" height = 200px width= auto>
    </div>
    <!--right column-->
    <div class="emp_right">
          <?php 
        include 'variables.php';
            echo "
            <h1>Hello! My name is " . $emp3_name . ".</h1>
            <hr>
            <h3>I am " . $emp3_age . " years old.</h3>
            <h3>My job title is " . $emp3_jobTitle . ".</h3>
            <h3>My favorite drink is a " . $emp3_favDrink . ".</h3>
            <h3>My favorite scripture in the Bible is " . $emp3_favScripture . ".</h3>
            ";  
        ?>
    </div>
    </div>
