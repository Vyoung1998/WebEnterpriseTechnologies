...
<!--Product 1-->    
    <div class="product">
        ...
        <img src="frenchvanillacap.png" alt="A French Vanilla Cappucino in a mug, sitting on a table at a cafe" height= 250px>
        <!--description of product-->
            <h2>French Vanilla Cappucino</h2>
            <p>This lovely french vanilla Cappucino is made with whole steamed milk, one shot of expresso, mixed in with 2 pumps of our french vanilla syrup.
                Topped with whip cream and cinnamon, it's a perfect treat in the morning.
                 <br>
                The price is 4.50$.
            </p>
        </div>
    ...
    <!--what flavors are the best?-->
     <h3>What additives would you enjoy the most with this drink?</h3>
            <p><input type="radio" name="3" value="whip cream" required>Whip Cream</p>
            <p><input type="radio" name="3" value="chocolate syrup" required>Chocolate Syrup</p>
            <p><input type="radio" name="3" value="caramel syrup" required>Caramel Syrup</p>
            <p><input type="radio" name="3" value="rainbow sprinkles" required>Rainbow Sprinkles</p>
            <p><input type="radio" name="3" value="cherry on top" required>Cherry on top</p>  
    <!--Asking about aroma-->
