...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <!--Get Form Results-->
   <h3 class="message">Thank you <?php echo $_GET["name"]; ?> for your feedback. God bless you!</h3>
    <table>
        <tr>
            <th>
...
<!--Question 1-->
        <tr>
            <td><h3>How do you like the colors of this product?</h3><br><p>You said <?php echo $_GET["1"]; ?></p></td>
...
<!--Question 2-->
        <tr>
            <td><h3>How satisfied are you with the value of this product for the price listed?</h3><br><p>You said <?php echo $_GET["2"]; ?></p></td>
...
<!--Question 3-->
        <tr>
            <td><h3>What other colors would you like for this product?</h3><br><p>You said <?php echo $_GET["3"]; ?></p></td>
...
<!--Question 4-->
        <tr>
            <td><h3>How do you feel about the quality of this product?</h3><br><p>You said <?php echo $_GET["4"]; ?></p></td>
...
<!--Question 5-->
        <tr>
            <td><h3>Rate how true this statement is: "This is the best Bible and stationery pack ever."</h3><br><p>You said <?php echo $_GET["5"]; ?></p></td>
            <td><h3>Rate how true this statement is: "This is the best cup of coffee I've ever had."</h3><br><p>You said <?php echo $_GET["10"]; ?></p></td>
            <td><h3>Rate how true this statement is: "This is the best cup of coffee I've ever had."</h3><br><p>You said <?php echo $_GET["15"]; ?></p></td>
        </tr>
<!--Comments-->
        <tr>
