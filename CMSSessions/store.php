...
Purpose of this page: This is the store page. It lists the 10 items with photos, descriptions, quantities and prices.
One is a featured limited time product.
...
<?php
   session_start();
//don't do anything, this allows name to show if logged in and guest to view.
   ?>
